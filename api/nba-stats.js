...
export default async function handler(req) {
  ...
  const rowSet = [
    ...
    ["Ajay Mitchell",1.1,3.1,0.347],
    ["Amen Thompson",0.3,1.5,0.216],
    ["Andre Drummond",0.5,1.4,0.356],
    ["Anthony Black",1.6,4.7,0.333],
    ["Ausar Thompson",0.1,0.3,0.25],
    ["Ayo Dosunmu",1.8,4.1,0.439],
    ["Bones Hyland",1.6,4.2,0.388],
    ["Cameron Johnson",2,4.7,0.43],
    ["Caris LeVert",1,3,0.333],
    ["Collin Gillespie",2.9,7.2,0.401],
    ["Daniss Jenkins",1,2.7,0.374],
    ["Dean Wade",1.2,3.3,0.362],
    ["Deni Avdija",1.9,6,0.318],
    ["Devin Vassell",2.5,6.4,0.384],
    ["Donovan Clingan",1.1,3.2,0.341],
    ["Harrison Barnes",1.8,4.6,0.388],
    ["Isaiah Stewart",0.7,2.1,0.333],
    ["Ja'Kobe Walter",1.5,3.7,0.409],
    ["Jae'Sean Tate",0.2,0.7,0.313],
    ["Jake LaRavia",1,3,0.321],
    ["Jalen Johnson",1.7,4.7,0.352],
    ["Jalen Suggs",2.1,6.3,0.339],
    ["Jamal Shead",1,3.2,0.321],
    ["Jarred Vanderbilt",0.4,1.5,0.293],
    ["Jerami Grant",2.4,6.1,0.389],
    ["Jeremy Sochan",0.3,1,0.244],
    ["Jordan Clarkson",1,3,0.327],
    ["Jordan Walsh",0.7,1.8,0.384],
    ["Jose Alvarado",1.5,4.2,0.352],
    ["Julian Champagnie",2.4,6.2,0.381],
    ["Justin Edwards",1,2.8,0.372],
    ["Keldon Johnson",1.2,3.3,0.363],
    ["Kelly Oubre Jr.",1.7,4.8,0.36],
    ["Kenrich Williams",1,2.8,0.353],
    ["Kris Murray",0.9,2.8,0.329],
    ["Kyle Anderson",0.1,0.3,0.364],
    ["Luka Garza",0.8,1.8,0.433],
    ["Marcus Smart",1.6,4.7,0.331],
    ["Matisse Thybulle",1.2,3.1,0.398],
    ["Onyeka Okongwu",1.9,5.2,0.376],
    ["Paul George",2.7,6.9,0.392],
    ["Paul Reed",0.2,0.6,0.325],
    ["Reed Sheppard",2.8,7,0.394],
    ["Royce O'Neale",2.7,6.7,0.408],
    ["Scoot Henderson",1.9,5.4,0.352],
    ["Shaedon Sharpe",2.1,6.1,0.337],
    ["Spencer Jones",0.9,2.3,0.396],
    ["Stephon Castle",1.2,3.6,0.332],
    ["Toumani Camara",2.7,7.2,0.37],
    ["Tyrese Maxey",3.1,8.6,0.367],
    ["A. Lawson",0.8,1.9,0.422],
    ["Brice Scheierman",1.3,3.2,0.399],
    ["Bronny James Jr.",0.5,1.4,0.386],
    ["Bruce Brown Jr.",0.7,1.8,0.385],
    ["C. Bryant",0.7,2.2,0.335],
    ["Colby Murray-Boyles",0.3,0.9,0.34],
    ["D. Barlow",0.3,1.2,0.256],
    ["D. Harper",0.9,2.6,0.343],
    ["J. Cain",0.7,1.8,0.384],
    ["J. Tyson",2,4.5,0.446],
    ["J.T. McCain",1.5,3.8,0.385],
    ["K. Ellis",1.3,3.5,0.363],
    ["Ron Holland II",0.6,2.5,0.253],
    ["Ryan Fleming",0.8,2.4,0.346],
    ["Tristan da Silva",1.6,4.2,0.374],
    ["Victor Edgecombe",2,5.6,0.354],
    ["Kareem Maluach",0.1,0.5,0.238],
    ["Josh Bouyea",0.5,1.7,0.295],
    ["Josh Goodwin",1.6,4.3,0.371],
    ["Alperen Sengun",0.5,1.5,0.33]
  ];
